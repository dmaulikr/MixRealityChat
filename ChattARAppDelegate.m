...
- (BOOL)application:(UIApplication *)application didFinishLaunchingWithOptions:(NSDictionary *)launchOptions
{
    ...
    [QBSettings setApplicationID:60597];
    [QBSettings setAuthorizationKey:@"6cu6TnNgHNAQ6Wh"];
    [QBSettings setAuthorizationSecret:@"tVPKLCqvh6YrkCb"];
//    [QBSettings setAccountKey:@"aDrhtVH8V1pyr3zgEPJ3"];
